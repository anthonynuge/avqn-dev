export const projects = [
  {
    title: "Maze Solver",
    description:
      "Built in Java, this maze solver app was created to explore and learn pathfinding algorithms. It visualizes the process of finding the optimal path through a maze, offering an interactive way to understand algorithms like A* and BFS.",
